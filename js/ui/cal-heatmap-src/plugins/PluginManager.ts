...
import { PluginDefinition, PluginOptions, IPluginContructor, IPlugin } from '../index';
...
function createPlugin(Creator: IPluginContructor, calendar: CalHeatmap): IPlugin {
    return new Creator(calendar);
}

function extractPluginName(PluginClass: IPluginContructor, options?: PluginOptions): string {
