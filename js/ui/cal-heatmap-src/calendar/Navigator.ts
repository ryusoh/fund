...
export default class Navigator {
    ...
    loadNewDomains(
        ...
        if (this.#isDomainBoundaryReached(newDomainCollection, minDate, maxDate, direction)) {
    ...
    jumpTo(date: Date, reset: boolean): ScrollDirection {
        ...
        if (reset) {
            return this.loadNewDomains(
                ...
                minDate < date ? ScrollDirection.SCROLL_FORWARD : ScrollDirection.SCROLL_BACKWARD
            );
        }
