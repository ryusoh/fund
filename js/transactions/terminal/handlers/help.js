...
export function handleHelpCommand(args, { appendMessage }) {
    if (args.length === 0) {
        ...
        const result =
            ...
            '                                    composition-abs, sectors, sectors-abs, geography, geography-abs, concentration, pe, fx\n' +
            ...
            '                                 plot sectors abs, plot geography, plot geography abs, plot concentration, plot pe, plot fx\n' +
