import { BASE_URL, HOLDINGS_DETAILS_URL, FUND_DATA_URL, COLORS, CHART_DEFAULTS, APP_SETTINGS, UI_BREAKPOINTS, CURRENCY_SYMBOLS, COLOR_PALETTES, PLUGIN_CONFIGS, TICKER_TO_LOGO_MAP, DATA_PATHS, CALENDAR_SELECTORS, CALENDAR_CONFIG } from '../config.js';
