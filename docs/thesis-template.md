...
#### 4.2.4 Evidence & supporting material (Bull)
    ...
    - Links / files:
        - {{notes/{{TICKER}}/{{TICKER}}-bull-evidence.md or external URLs}}
...
#### 4.3.4 Evidence & supporting material (Base)
    ...
    - Links / files:
        - {{notes/{{TICKER}}/{{TICKER}}-base-evidence.md or external URLs}}
...
#### 4.4.4 Evidence & supporting material (Bear)
    ...
    - Links / files:
        - {{notes/{{TICKER}}/{{TICKER}}-bear-evidence.md or external URLs}}
...
Detailed notes can live in separate files under `notes/{{TICKER}}/`.

### 8.1 Log index

    - Bull evidence file: `notes/{{TICKER}}/{{TICKER}}-bull-evidence.md`
    - Base evidence file: `notes/{{TICKER}}/{{TICKER}}-base-evidence.md`
    - Bear evidence file: `notes/{{TICKER}}/{{TICKER}}-bear-evidence.md`
