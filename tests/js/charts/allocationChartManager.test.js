...
function setupMocks() {
    mockChartInstance = {
        ...
        getDatasetMeta: jest.fn(() => ({
            data: [
                { x: 150, y: 150, innerRadius: 50, outerRadius: 100, startAngle: 0, endAngle: 1.5 },
            ],
        })),
...
describe('chartManager', () => {
    ...
    describe('imagePlugin', () => {
        it('should call drawImage when logos are shown', () => {
            ...
            const { drawImage } = require('@charts/imageDrawer.js');
    ...
    describe('datalabels configuration', () => {
        it('should format datalabels correctly (lines 89-95)', () => {
            ...
            const result = datalabelsConfig.formatter(25.5, mockContext);

            expect(result).toEqual([{ text: 'AAPL' }, { text: '25.50%' }]);
        });
        ...
        it('should format datalabels with different values and indices', () => {
            ...
            expect(result).toEqual([{ text: 'GOOG' }, { text: '42.75%' }]);
        });
        ...
        it('should format datalabels with decimal precision', () => {
            ...
            expect(result).toEqual([{ text: 'AAPL' }, { text: '33.33%' }]);
        });
