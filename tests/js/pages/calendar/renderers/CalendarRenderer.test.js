...
describe('CalendarRenderer', () => {
    ...
    test('paint throws not implemented', () => {
        expect(() => renderer.paint({})).toThrow('CalendarRenderer.paint() not implemented');
    });

    test('next throws not implemented', () => {
        expect(() => renderer.next(1)).toThrow('CalendarRenderer.next() not implemented');
    });

    test('previous throws not implemented', () => {
        expect(() => renderer.previous(1)).toThrow('CalendarRenderer.previous() not implemented');
    });

    test('jumpTo throws not implemented', () => {
        expect(() => renderer.jumpTo(new Date())).toThrow('CalendarRenderer.jumpTo() not implemented');
    });

    test('on throws not implemented', () => {
        expect(() => renderer.on('test', () => {})).toThrow('CalendarRenderer.on() not implemented');
    });

    test('renderState throws not implemented', () => {
        expect(() => renderer.renderState({})).toThrow('CalendarRenderer.renderState() not implemented');
    });

    test('destroy throws not implemented', () => {
