...
def fetch_benchmark_pe_daily(
    ...
    try:
        ...
        try:
            ...
            print(f"Warning: Exception fetching EPS data for {proxy_ticker}: {e}")
        ...
        try:
            ...
            print(f"Warning: Exception fetching quarterly EPS data for {proxy_ticker}: {e}")
    ...
    for bmk_ticker, proxy_etf in BENCHMARK_PE_TICKERS.items():
        ...
        if BENCHMARK_HISTORY_PATH.exists():
            try:
                ...
                print(f"Warning: Exception loading manual anchors for {bmk_ticker}: {e}")
